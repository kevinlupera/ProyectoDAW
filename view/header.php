       ...
       <div class="container">
           ...
           <nav>
                ...
                <div class="barra-navegacion">
                    ...
                    <a id="cesta" href="index.php?c=cesta" class="item"><i class="fa fa-cart-plus" aria-hidden="true"></i>&nbsp;Cesta</a>
                    ...
                    <a id="reportes" href="index.php?c=usuario&a=consultar" class="item"><i class="fa fa-line-chart" aria-hidden="true"></i>&nbsp;Lista Usuarios</a>
